...
window.projects = [
...

  {
    ...
    details: [
      ...
      "Includes RSVP integration for guest responses.",
      "Photo gallery and countdown timer sections.",
...

  {
    ...
    tech: ["CSS", "MySQLi", "PHP"],
    details: [
      "Displays sales analytics and order statistics.",
...

  {
    ...
    details: [
      "Live content update system using Redis.",
      "Data visualization for news engagement.",
      "Dynamic category pages and news search.",
...

  {
    ...
    tech: ["Next.js", "MySQLi", "PHP"],
    details: [
      "Implemented user and vendor authentication.",
      "Integrated live order tracking and updates.",
...

  {
    ...
    tech: ["React Native", "Sass", "CSS"],
    details: [
      "Creative use of CSS animations and keyframes.",
      "3D orbit effects with layered depth illusion.",
